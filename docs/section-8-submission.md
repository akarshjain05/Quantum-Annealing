...
* An intelligent agentic layer that strictly separates formal regulation, observed settlement practice, and internal model assumptions—operating alongside LLM capabilities.
